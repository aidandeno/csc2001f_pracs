...
public class TreeUtils
{
    ...
    public static int dataToKey(String data)
    {
        Character c = Character.toLowerCase(data.charAt(0));
        return c - 'a' + 1;
    }
    ...
    /**
     * Determine whether the given tree structure contains the given value.
     */
    public static boolean contains(AVLTreeNode node, String data)
    {
        ...
        else if ((int) TreeUtils.dataToKey(data) < node.getKey())
        {
            if (node.hasLeft())
            {
     ...
     */
    public static AVLTreeNode insert(AVLTreeNode node, Integer key, String data)
    {
        if (node == null)
        {
